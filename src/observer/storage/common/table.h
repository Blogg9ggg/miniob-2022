...
public:
  ...
  RC create_index(Trx *trx, const char *index_name, const char *attribute_name,bool flag);
...
private:
  ...
  RC update_entry_of_indexes(const char *old_record, const char *new_record, const RID &rid, const char *update_field);
