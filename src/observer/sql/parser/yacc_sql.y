...
create_unique_index: /* 小王同学:  create  unique index 语句的语法解析树*/
...
show_index:	/* 李立基: show index 语句的语法解析树*/
...
value:
	...
	|DATE_STR{ // 李立基: 初始化 date, 用 int 類型保存數據, 并且檢查日期是否合法, 不合法返回 SCF_INVALID_VALUE
